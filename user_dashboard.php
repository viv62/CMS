...
<body>
  ...
  <img class="card-img-top" src="images/result.jpg" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">Result</h5>
    <p class="card-text">Check your Result by entering enrollnment number.</p>
    <a href="result_form.php" class="btn btn-primary">View Result</a>
  </div>
</div>
    </div>
    <div class="col-sm">
    <div class="card" style="width: 18rem; border: 1px solid black;">
  <img class="card-img-top" src="images/img4.jpg">
  <div class="card-body">
    <h5 class="card-title">Assignment</h5>
    <p class="card-text">Please complete your assignment before the deadline.</p>
    <a href="assignment.php" class="btn btn-primary">View Assignment</a>
  </div>
</div>
    </div>
    <div class="col-sm">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Attendance should be 75% .click below to check your attendance</p>
