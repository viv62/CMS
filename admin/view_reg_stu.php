...
$query = "SELECT students.name,students.enroll,students.mobile,students.email,add_students.address FROM students LEFT JOIN add_students ON students.enroll = add_students.enroll";
