...
$age = "";
$state = "";
$query = "SELECT * FROM add_students WHERE enroll = '$_POST[enroll]'";
...
<body>
 ...
 <center><h4>Update Details</h4></center><br>


  <div class="container">
      <div class="row">
        <div class="col-sm">
          <form action="edit_stu_data.php" method="POST">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                ...
                <input type="text" name = "enroll" class="form-control" value="<?php echo $enroll; ?>">
              </div>
            </div>
            ...
            <div class="form-group">
              <label>Address</label>
              <input type="text" name="address" class="form-control"  placeholder="Area, landmark" value="<?php echo $address; ?>">
            </div>
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-2">
                ...
                <input type="text" name="dept_id" class="form-control" value="<?php echo $dept_id; ?>">
              </div>
            </div>
