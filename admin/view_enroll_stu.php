...
$query = "SELECT add_students.name,add_students.enroll,add_students.session,add_students.mobile, add_students.email,course.course_name,department.dept_name,add_students.gender,add_students.address FROM add_students LEFT JOIN department ON add_students.dept_id = department.dept_id LEFT JOIN course ON add_students.course_id=course.course_id";
...
<body>
  ...
  <br> 
<center><h4>Students Details</h4></center>
...
<table class="table table-bordered">
  <thead>
    <tr>
      ...
      <th scope="col">Enrollnment No.</th>
