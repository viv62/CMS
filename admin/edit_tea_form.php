...
<body>
  ...
  <div class="form-group">
    ...
    <br>
    <br>
    <label><strong>Faculty id</strong></label>
    <input type="text" name="f_id" class="form-control"  placeholder="Enter Faculty id" style="border:1px solid black;">
    <small class="form-text text-muted">Click Search to search the selected Faculty.</small>
  </div>
