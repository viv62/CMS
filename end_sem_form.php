...
<body>
  ...
  <div class="row">
    ...
    <form action="end_sem.php" method="POST">
  <div class="form-group">
    ...
    <input type="text" name="enroll" class="form-control"  placeholder="Enter Enrollnment Number">
    <small class="form-text text-muted">Click View marks to view the Marks.</small>
  </div>
  <button type="submit" class="btn btn-success">View Marks</button>
</form>
    </div>
    <div class="col-sm">
    </div>
